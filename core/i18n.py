...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "autostart.on": "Auto-start enabled — JARVIS will launch at login.",
        "autostart.off": "Auto-start disabled.",
        "autostart.failed": "Auto-start could not be changed",
        "clipboard.on": "Clipboard quick actions enabled.",
        "clipboard.off": "Clipboard quick actions disabled.",
        "clipboard.detected": "CLIPBOARD DETECTED",
        "clipboard.translate": "TRANSLATE",
        "clipboard.summarise": "SUMMARISE",
        "clipboard.explain": "EXPLAIN",
        "clipboard.fix": "FIX",
        "clipboard.cmd_translate": "Translate this text to English: {text}",
        "clipboard.cmd_summarise": "Summarise this text: {text}",
        "clipboard.cmd_explain": "Explain this text: {text}",
        "clipboard.cmd_fix": "Fix the grammar and spelling of this text: {text}",
        "assistant.saved": "Assistant settings saved. Restart to fully apply the name.",
        "perm.title": "PERMISSIONS",
        "perm.intro": "Grant these so JARVIS can fully control your Mac, see the screen, and hear you.",
        "perm.accessibility": "Accessibility",
        "perm.accessibility_desc": "Control apps & send messages (keyboard / mouse)",
        "perm.automation": "Automation",
        "perm.automation_desc": "Send commands to other apps",
        "perm.screen_recording": "Screen Recording",
        "perm.screen_recording_desc": "See your screen",
        "perm.microphone": "Microphone",
        "perm.microphone_desc": "Hear your voice",
        "perm.camera": "Camera",
        "perm.camera_desc": "See through the webcam",
        "perm.status_granted": "Granted",
        "perm.status_denied": "Not granted",
        "perm.status_unknown": "Unknown",
        "perm.status_not_required": "Not required",
        "perm.grant": "GRANT",
        "perm.open_settings": "OPEN SETTINGS",
        "perm.recheck": "RE-CHECK",
        "perm.done": "DONE",
        "perm.restart_note": "After granting in System Settings, fully restart JARVIS to apply.",
        "perm.all_set": "All set — JARVIS has the permissions it needs.",
        "settings.permissions": "Permissions",
        "settings.open_permissions": "PERMISSIONS",
        ...
        "settings.autostart": "Launch at login (auto-start)",
        "settings.autostart_unsupported": "Not supported on this system",
        "settings.clipboard": "Clipboard quick actions",
        "settings.assistant": "Assistant identity",
        "settings.assistant_name": "Assistant name",
        "settings.your_name": "Your name (optional)",
        "settings.assistant_restart_note": "Restart to fully apply the assistant name.",
        ...
        "settings.update_downloaded": "Update downloaded and cryptographically verified. Installation is not available in this build.",
    ...
    "ru": {
        ...
        "autostart.on": "Автозапуск включён — JARVIS будет запускаться при входе.",
        "autostart.off": "Автозапуск отключён.",
        "autostart.failed": "Не удалось изменить автозапуск",
        "clipboard.on": "Быстрые действия с буфером обмена включены.",
        "clipboard.off": "Быстрые действия с буфером обмена отключены.",
        "clipboard.detected": "БУФЕР ОБМЕНА",
        "clipboard.translate": "ПЕРЕВЕСТИ",
        "clipboard.summarise": "КРАТКО",
        "clipboard.explain": "ОБЪЯСНИТЬ",
        "clipboard.fix": "ИСПРАВИТЬ",
        "clipboard.cmd_translate": "Переведи этот текст на русский язык: {text}",
        "clipboard.cmd_summarise": "Сделай краткое изложение этого текста: {text}",
        "clipboard.cmd_explain": "Объясни этот текст: {text}",
        "clipboard.cmd_fix": "Исправь грамматику и орфографию этого текста: {text}",
        "assistant.saved": "Настройки ассистента сохранены. Перезапустите, чтобы имя применилось полностью.",
        "perm.title": "РАЗРЕШЕНИЯ",
        "perm.intro": "Выдайте их, чтобы JARVIS мог полностью управлять Mac, видеть экран и слышать вас.",
        "perm.accessibility": "Универсальный доступ",
        "perm.accessibility_desc": "Управление приложениями и отправка сообщений (клавиатура / мышь)",
        "perm.automation": "Автоматизация",
        "perm.automation_desc": "Отправка команд другим приложениям",
        "perm.screen_recording": "Запись экрана",
        "perm.screen_recording_desc": "Видеть ваш экран",
        "perm.microphone": "Микрофон",
        "perm.microphone_desc": "Слышать ваш голос",
        "perm.camera": "Камера",
        "perm.camera_desc": "Видеть через веб-камеру",
        "perm.status_granted": "Выдано",
        "perm.status_denied": "Не выдано",
        "perm.status_unknown": "Неизвестно",
        "perm.status_not_required": "Не требуется",
        "perm.grant": "ВЫДАТЬ",
        "perm.open_settings": "ОТКРЫТЬ НАСТРОЙКИ",
        "perm.recheck": "ПРОВЕРИТЬ СНОВА",
        "perm.done": "ГОТОВО",
        "perm.restart_note": "После выдачи в Системных настройках полностью перезапустите JARVIS.",
        "perm.all_set": "Всё готово — у JARVIS есть нужные разрешения.",
        "settings.permissions": "Разрешения",
        "settings.open_permissions": "РАЗРЕШЕНИЯ",
        ...
        "settings.autostart": "Запуск при входе (автозапуск)",
        "settings.autostart_unsupported": "Не поддерживается в этой системе",
        "settings.clipboard": "Быстрые действия с буфером",
        "settings.assistant": "Личность ассистента",
        "settings.assistant_name": "Имя ассистента",
        "settings.your_name": "Ваше имя (необязательно)",
        "settings.assistant_restart_note": "Перезапустите, чтобы имя ассистента применилось полностью.",
        ...
        "settings.update_downloaded": "Обновление скачано и криптографически проверено. Установка в этой сборке недоступна.",
